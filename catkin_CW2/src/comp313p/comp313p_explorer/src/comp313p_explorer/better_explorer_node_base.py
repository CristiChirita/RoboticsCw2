...
class BetterExplorerNodeBase(object):
    ...
    def isFrontierCell(self, x, y):
        ...
        #     | self.checkIfCellIsUnknown(x, y, -1, 1) | self.checkIfCellIsUnknown(x, y, -1, 0)
	return self.checkIfCellIsUnknown(x, y, 0, -1) | self.checkIfCellIsUnknown(x, y, 1, 0) | self.checkIfCellIsUnknown(x, y, 0, 1) | self.checkIfCellIsUnknown(x, y, -1, 0)
    ...
    def run(self):
        ...
        explorerThread = BetterExplorerNodeBase.ExplorerThread(self)
